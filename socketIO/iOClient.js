...
import { sendCocketConnectionSuccess,recivedJoinedToRoom, handleDisconnect, handleNewMessage} from "../utils/socketIO.js";
...
iOClient.on(CONNECTION, (socket) => {
  ...
  socket.on(JOINED_TO_ROOM_REQUEST, (payload) => recivedJoinedToRoom({...serverData, payload}));
